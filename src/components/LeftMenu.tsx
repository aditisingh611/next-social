...
const LeftMenu = ({type}:{type:"home"|"Profile"}) => {
    return(
        <div className="flex flex-col gap-6">
            ...
            <div className="p-4 bg-purple-300 rounded-lg shadow-md text-gray-700 text-sm flex flex-col gap-2">
                <Link href="/" className="flex items-center gap-4 p-2 rounded-lg">
